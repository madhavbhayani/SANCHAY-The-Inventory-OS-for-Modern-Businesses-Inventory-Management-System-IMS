...
func main() {
	...
	mux.HandleFunc("POST /api/auth/forgot-password/request", auth.ForgotPasswordRequestOTP)
	mux.HandleFunc("POST /api/auth/forgot-password/verify", auth.ForgotPasswordVerifyOTP)
	mux.HandleFunc("POST /api/auth/forgot-password/reset", auth.ForgotPasswordReset)
	...
	go func() {
		...
		log.Println("[SERVER]   POST /api/auth/forgot-password/request")
		log.Println("[SERVER]   POST /api/auth/forgot-password/verify")
		log.Println("[SERVER]   POST /api/auth/forgot-password/reset")
